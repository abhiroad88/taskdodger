function Excuse() {
	...
	var Dog = ['Nic', 'Matt', 'Daphne', 'Abi', 'Lottie', 'James', 'Emma', 'Katinka', 'Slack', 'Bynder', 'Carl', 'COVID-19', 'Trello', 'Photoshop', 'Illustrator', 'Premiere', 'Google Docs', 'Claudia', 'Boris'];
	var ate = ['killed', 'destroyed', 'deleted', 'erased', 'judged', 'stole', 'disliked', 'hated', 'ruined', 'barfed on', 'stole', 'spilled tea on', 'made me change', 'dunked on'];
